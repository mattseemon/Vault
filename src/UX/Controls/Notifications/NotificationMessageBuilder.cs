...
namespace Seemon.Vault.Controls.Notifications
{
    ...
    public class NotificationMessageBuilder
    {
        ...
        public static NotificationMessageBuilder CreateMessage() => new NotificationMessageBuilder();

        /// <summary>
        /// Sets the header.
        /// </summary>
        /// <param name="header">The header.</param>
        public void SetHeader(string header) => this.Message.Header = header;

        /// <summary>
        /// Sets the message.
        /// </summary>
        /// <param name="message">The message.</param>
        public void SetMessage(string message) => this.Message.Message = message;
        ...
        public void SetBadge(string badgeText) => this.Message.BadgeText = badgeText;

        /// <summary>
        /// Sets the accent.
        /// </summary>
        /// <param name="accentBrush">The accent brush.</param>
        public void SetAccent(Brush accentBrush) => this.Message.AccentBrush = accentBrush;

        /// <summary>
        /// Sets the background.
        /// </summary>
        /// <param name="backgroundBrush">The background brush.</param>
        public void SetBackground(Brush backgroundBrush) => this.Message.Background = backgroundBrush;

        /// <summary>
        /// Sets the overlay.
        /// </summary>
        /// <param name="overlay">The overlay.</param>
        public void SetOverlay(object overlay) => this.Message.OverlayContent = overlay;

        /// <summary>
        /// Sets the top additional content.
        /// </summary>
        /// <param name="additionalContentTop">The additional content.</param>
        public void SetAdditionalContentTop(object additionalContentTop) => this.Message.AdditionalContentTop = additionalContentTop;

        /// <summary>
        /// Sets the bottom additional content.
        /// </summary>
        /// <param name="additionalContentBottom">The additional content.</param>
        public void SetAdditionalContentBottom(object additionalContentBottom) => this.Message.AdditionalContentBottom = additionalContentBottom;

        /// <summary>
        /// Sets the left additional content.
        /// </summary>
        /// <param name="additionalContentLeft">The additional content.</param>
        public void SetAdditionalContentLeft(object additionalContentLeft) => this.Message.AdditionalContentLeft = additionalContentLeft;

        /// <summary>
        /// Sets the right additional content.
        /// </summary>
        /// <param name="additionalContentRight">The additional content.</param>
        public void SetAdditionalContentRight(object additionalContentRight) => this.Message.AdditionalContentRight = additionalContentRight;

        /// <summary>
        /// Sets the center additional content.
        /// </summary>
        /// <param name="additionalContentMain">The additional content.</param>
        public void SetAdditionalContentMain(object additionalContentMain) => this.Message.AdditionalContentMain = additionalContentMain;

        /// <summary>
        /// Sets the additional content over the badge.
        /// </summary>
        /// <param name="additionalContentOverBadge">The additional content.</param>
        public void SetAdditionalContentOverBadge(object additionalContentOverBadge) => this.Message.AdditionalContentOverBadge = additionalContentOverBadge;

        /// <summary>
        /// Sets the text brush.
        /// </summary>
        public void SetForeground(Brush brush) => this.Message.Foreground = brush;
        ...
        /// <param name="action">The action.</param>
        public void Delay(TimeSpan delay, Action<INotificationMessage> action) => Task.Delay(delay).ContinueWith(context => action(this.Message), TaskScheduler.FromCurrentSynchronizationContext());
        ...
        public class DismissNotificationMessage
        {
            ...
            public DismissNotificationMessage(NotificationMessageBuilder builder) => this.Builder = builder ?? throw new ArgumentNullException(nameof(builder));
