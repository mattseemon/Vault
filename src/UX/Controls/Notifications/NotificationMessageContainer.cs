...
namespace Seemon.Vault.Controls.Notifications
{
    ...
    public class NotificationMessageContainer : ItemsControl
    {
        ...
        private void RemoveMessage(INotificationMessage message) => this.Items.Remove(message);
        ...
        /// </summary>
        static NotificationMessageContainer() => DefaultStyleKeyProperty.OverrideMetadata(typeof(NotificationMessageContainer), new FrameworkPropertyMetadata(typeof(NotificationMessageContainer)));
    }
}
