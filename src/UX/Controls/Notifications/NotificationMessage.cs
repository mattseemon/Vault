...
namespace Seemon.Vault.Controls.Notifications
{
    ...
    public class NotificationMessage : Control, INotificationMessage, INotificationAnimation
    {
        ...
        {
            get => GetValue(AccentBrushProperty) as Brush;
        ...
        {
            get => GetValue(ButtonAccentBrushProperty) as Brush;
        ...
        {
            get => GetValue(BadgeAccentBrushProperty) as Brush;
        ...
        public AnimationTimeline AnimationIn
        {
            get
            {
                ...
                if (animation != null)
                {
                    animation.Duration = TimeSpan.FromSeconds(this.AnimationInDuration);
                    return animation;
                }
                else
                {
                    var doubleAnimation = new DoubleAnimation
                    {
                        ...
                        Duration = TimeSpan.FromSeconds(this.AnimationInDuration),
        ...
        public AnimationTimeline AnimationOut
        {
            get
            {
                ...
                if (animation != null)
                {
                    animation.Duration = TimeSpan.FromSeconds(this.AnimationOutDuration);
                    return animation;
                }
                else
                {
                    return new DoubleAnimation
                    {
                        ...
                        To = 0,
                        BeginTime = TimeSpan.FromSeconds(0),
                        Duration = TimeSpan.FromSeconds(this.AnimationOutDuration),
                        FillBehavior = FillBehavior.HoldEnd
                    };
                }
            }
        ...
        /// </summary>
        static NotificationMessage() => DefaultStyleKeyProperty.OverrideMetadata(typeof(NotificationMessage), new FrameworkPropertyMetadata(typeof(NotificationMessage)));
